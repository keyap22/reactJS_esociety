...
//     const { REACT_APP_VAPID_KEY } = process.env;
 const publicKey = "BClCkuRZPf9c8s45xkA_7GDTgBKU82Yyb7p1yq6_9qHRILli8-tgldoW7MmoOqBOn70iT_5-vQqMl7o5ehtjuo8";//REACT_APP_VAPID_KEY

// export const getToken = async (setTokenFound) => {
//   let currentToken = "";

//   try {
//     currentToken = await firebase_messaging.getToken({ vapidKey: publicKey });
//     if (currentToken) {
//       setTokenFound(true);
//     } else {
//       setTokenFound(false);
...
export const getToken1 = (setTokenFound) => {
  return getToken(firebase_messaging, {vapidKey: publicKey}).then((currentToken) => {
    if (currentToken) {
